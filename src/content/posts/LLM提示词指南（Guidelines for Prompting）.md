---
title: "LLM提示词指南（Guidelines for Prompting）"
description: "编写Prompt的两个关键原则：编写清晰、具体的提示和给予LLM一定的思考时间"
...
category: "大模型应用"
author: "0x3a0"
sourceLink: "https://github.com/0x3a0/blog/src/posts/LLM提示词指南（Guidelines for Prompting）.md"
---
...
开发者可以通过Prompt来减少幻觉发生的可能，例如将原本真实的信息通过Prompt的方式传递给模型，这可以让模型直接引用真实文本中的原句，然后再进行解答，这样可以降低生成虚假内容的概率。
...
+ [https://www.nvidia.cn/glossary/retrieval-augmented-generation/](https://www.nvidia.cn/glossary/retrieval-augmented-generation/)
...
+ [https://modelcontextprotocol.io/overview](https://modelcontextprotocol.io/overview)
+ [https://www.runoob.com/np/mcp-protocol.html](https://www.runoob.com/np/mcp-protocol.html)
